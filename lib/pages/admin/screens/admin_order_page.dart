...
class AdminOrderPage extends StatefulWidget {
  ...
  const AdminOrderPage({Key? key, required this.order}) : super(key: key);

  @override
  State<AdminOrderPage> createState() => _OrderDetailPageState();
}

class _OrderDetailPageState extends State<AdminOrderPage> {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        'Shipping Address: ${"${widget.order.address.line1} ${widget.order.address.line2} ${widget.order.address.city} ${widget.order.address.state} ${widget.order.address.postalCode} "}'),
                  ],
                ),
              ),
